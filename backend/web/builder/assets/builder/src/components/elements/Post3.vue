<template>
  <div v-if="posts.length">
    <div v-if="mode == 'list'" class="ukm-posts">
      <article
        class="ukm-post--list mt3"
        :class="post_container_classname ? post_container_classname : ''"
        :style="{'border-left': `10px solid ${bar_color}`}"
        v-for="post in posts"
        :key="post.id">
...
export default{
  ...
  props: {
    mode                      : { type: String },
    post_container_classname  : { type: String },
