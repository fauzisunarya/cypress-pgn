...
class CTA10 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'cta-10',
      "title"      => 'CTA 10',
      "screenshot" => 'cta-10/cta-10.jpg',
      "screenshot_size" => array( 600, 242 ),
      "template"   => '#cta-10',
      "category"   => 'call-to-action',
        "data" => array(
          ...
          "image" => array(
            "type" => "image",
            "label" => "Image",
            "value" => $this->base_url . 'builder/assets/builder/blocks-assets/imgs/photos/indihome-man.png'
          ),
...
$CTA10 = new CTA10();
$arrayCode[] = $CTA10->data();
$arrayTemplate[] = $CTA10->editorTemplate();