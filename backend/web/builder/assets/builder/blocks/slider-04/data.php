...
class Slider4 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'slider-04',
      "title"      => 'slider 04',
      "screenshot" => 'slider-04/slider-04.jpg',
      "screenshot_size" => array( 600, 262 ),
      "template"   => '#slider-04',
      "category"   => 'slider',
      "data" => array(
        "slides" => array(
        ...
        <?php foreach( $data->slides->value as $item ): ?>
          ...
          <div class="slide content-<?php echo $item->content_color->value; ?>" style="<?php echo $slide_bg; ?> --mobile-slide: url('<?php echo $mobile_slide_bg; ?>')">
            <div class="<?php echo (!$style->fullwidth->value) ? 'container' : 'container-fluid'; ?> <?php echo $item->alignment->value; ?>">
              <div class="content-spacer <?php echo $item->alignment->value; ?>">
...
$Slider4 = new Slider4();
$arrayCode[] = $Slider4->data();
$arrayTemplate[] = $Slider4->editorTemplate();