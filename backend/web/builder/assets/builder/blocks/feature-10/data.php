...
class Feature10 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'feature-10',
      "title"      => 'feature 10',
      "screenshot" => 'feature-10/feature-10.jpg',
            ...
            "value"  => array(
              ...
              array(
                ...
                "content" => array(
                  "type" => "wyswyg",
                  "label" => "Content",
                  "value" => "<p>Odit quo porro molestias error mollitia eligendi recusandae temporibus quibusdam obcaecati deleniti.</p>"
                ),
                "background" => array(
                  "type" => "color",
                  "label" => "Warna latar fitur",
              ...
              array(
                ...
                "title" => array(
                  ...
                  "heading" => true,
                  "horizontal" => true,
                  "value" => "<strong>Loved Design</strong>"
                ),
                "content" => array(
                  "type" => "wyswyg",
                  "label" => "Content",
  ...
  public function editorTemplate() {
    ...
    <div
      :id="`block-${id}`"
      class="icl-section icl-section--feature-10"
      ...
      <div :class="{'container': !style.fullwidth.value, 'container-fluid': style.fullwidth.value }">
        <div :class="`content-spacer`" :style="{'padding': `${style.padding.value.top}px ${style.padding.value.right}px ${style.padding.value.bottom}px ${style.padding.value.left}px`}">
          ...
          <Sortable class="feature-grid columns is-centered" v-model="data.features.value">
            <SortableItem class="column is-3" v-for="(item, index) in data.features.value" :key="`item-${index}`" :list="data.features.value" :index="index" :style="{
                backgroundColor: `${item.background.value}`,
                color: `${item.color.value}`
              }">
              <div class="icl-feature icl-feature--style-10">
  ...
  static function render($id, $data, $style) {
    ...
    <div
      ...
      class="icl-section icl-section--feature-10 content-<?php echo $style->content_color->value; ?>">
      <?php
        $background_style  = "";
      ...
      <div class="<?php echo (!$style->fullwidth->value) ? 'container' : 'container-fluid'; ?>">
        ...
        <div class="content-spacer" style="padding: <?php echo implode(" ", $padding); ?>">
          ...
          <div class="feature-grid columns is-centered">
            <?php foreach( $data->features->value as $item ): ?>
              <div class="column is-3" style="background-color: <?php echo $item->background->value; ?>;color:<?php echo $item->color->value; ?>">
                <div class="icl-feature icl-feature--style-10">
                  <div class="icl-feature__card">
...
$feature10 = new Feature10();
$arrayCode[] = $feature10->data();
$arrayTemplate[] = $feature10->editorTemplate();