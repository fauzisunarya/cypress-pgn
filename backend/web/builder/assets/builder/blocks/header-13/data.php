...
class Header13 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'header-13',
      "title"      => 'Header 13',
      "screenshot" => 'header-13/header-13.jpeg',
      "screenshot_size" => array( 600, 230 ),
      "template"   => '#header-13',
      "category"   => 'header',
        "data" => array(
          "logo" => array(
          ...
          "title" => array(
            ...
            "label" => "Judul Hero",
            "heading" => true,
            "value" => "<strong>Lorem ipsum dolor sit amet</strong>"
          ),
          "title_size" => array(
            "type" => "slider",
            "label" => "Ukuran Judul",
        ...
        "style" => array(
          ...
          "background" => array(
            ...
            "value"           => array(
              ...
              "backgroundImage"      => $this->base_url . 'builder/assets/builder/blocks-assets/imgs/photos/internet.png',
  ...
  public function editorTemplate() {
    ...
    <header
      :id="`block-${id}`"
      class="icl-header icl-header--style-13"
      ...
      <div :class="`page-hero ${data.alignment.value}`">
        <div
          ...
          <div class="hero-description" style="margin-bottom: 20px"><InlineEditor v-model="data.description.value" /></div>
  ...
  static function render($id, $data, $style, $header) {
    ...
    <header
      ...
      class="icl-header icl-header--style-13  content-<?php echo $style->content_color->value; ?>">
      <?php
        $background_style  = "";
...
$header13 = new Header13();
$arrayCode[] = $header13->data();
$arrayTemplate[] = $header13->editorTemplate();