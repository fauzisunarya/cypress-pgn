...
class Content27 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'content-27',
      "title"      => 'Content 27',
      "screenshot" => 'content-27/content-27.jpg',
      "screenshot_size" => array( 1393, 892 ),
      "template"   => '#content-27',
      "category"   => 'content',
        "data" => array(
          "image" => array(
  ...
  public function editorTemplate() {
    ...
    <div
      :id="`block-${id}`"
      class="icl-section icl-section--content-27"
  ...
  static function render($id, $data, $style) {
    ...
    <div
      ...
      class="icl-section icl-section--content-27 content-<?php echo $style->content_color->value; ?>">
      <?php
        $background_style  = "";
...
$content27 = new Content27();
$arrayCode[] = $content27->data();
$arrayTemplate[] = $content27->editorTemplate();