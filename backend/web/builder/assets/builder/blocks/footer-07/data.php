...
class Footer7 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'footer-07',
      "title"      => 'Footer 7',
      "screenshot" => 'footer-07/footer-07.jpg',
      "screenshot_size" => array( 800, 126 ),
      "template"   => '#footer-07',
      "category"   => 'footer',
        "data" => array(
          "logo" => array(
  ...
  public function editorTemplate() {
    ...
    <footer
      :id="`block-${id}`"
      :class="`icl-section icl-footer icl-footer--style-7 content-${style.content_color.value}`"
  ...
  static function render($id, $data, $style, $header) {
    ...
    <footer
      ...
      class="icl-section icl-footer icl-footer--style-7  content-<?php echo $style->content_color->value; ?>"
...
$footer7 = new Footer7();
$arrayCode[] = $footer7->data();
$arrayTemplate[] = $footer7->editorTemplate();