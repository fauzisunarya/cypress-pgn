...
class Slider2 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'slider-02',
      "title"      => 'slider 02',
      "screenshot" => 'slider-02/slider-02.jpg',
      "screenshot_size" => array( 600, 240 ),
      "template"   => '#slider-02',
      "category"   => 'slider',
      "data" => array(
        "slides" => array(
          ...
          "settings"   => array(
            "image" => array(
              "type" => "image",
              "label" => "Gambar",
              "value" => $this->base_url . 'builder/assets/builder/blocks-assets/imgs/photos/molatv.jpg'
            ),
          ),
          "value" => array(
            ...
            array(
              "image" => array(
                "type" => "image",
                "label" => "Gambar",
                "value" => $this->base_url . 'builder/assets/builder/blocks-assets/imgs/photos/longgateplay.jpg'
              ),
            ),
...
$Slider2 = new Slider2();
$arrayCode[] = $Slider2->data();
$arrayTemplate[] = $Slider2->editorTemplate();