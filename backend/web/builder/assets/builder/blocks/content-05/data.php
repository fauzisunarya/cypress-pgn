...
class Content5 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'content-05',
      "title"      => 'Content 5',
      "screenshot" => 'content-05/content-05.jpg',
      "screenshot_size" => array( 600, 263 ),
      "template"   => '#content-05',
      "category"   => 'content',
        "data" => array(
          ...
          "lightbox" => array(
            ...
            "value"           => 'https://www.youtube.com/watch?v=LXb3EKWsInQ',
          ),
          "reverse" => array(
            "type"            => 'switch',
            "label"           => 'Tukar Layout',
  ...
  public function editorTemplate() {
    ...
    <div
      :id="`block-${id}`"
      class="icl-section icl-section--content-5"
      ...
      <div :class="{'container': !style.fullwidth.value, 'container-fluid': style.fullwidth.value }">
        <div :class="`content-spacer`" :style="{'padding': `${style.padding.value.top}px ${style.padding.value.right}px ${style.padding.value.bottom}px ${style.padding.value.left}px`}">
          <div class="columns is-vcentered" :class="{'row-reverse': data.reverse.value == true }">
            <div :class="`column ${data.alignment.value}`">
            ...
            <div class="column has-text-centered">
              <a :href="data.lightbox.value" @click.prevent data-lightbox class="lightbox-video mfp-iframe">
    ...
    <div
      ...
      <div class="content-spacer" style="padding: <?php echo implode(" ", $padding); ?>">
        <div class="columns is-vcentered <?php echo $data->reverse->value == true ? "row-reverse" : ""; ?>">
          <div class="column <?php echo $data->alignment->value; ?>">
          ...
          <div class="column has-text-centered" data-aos="fade-up" data-aos-delay="300">
            <?php echo (!empty($data->lightbox->value)) ? '<a href="'. $data->lightbox->value.'" data-lightbox class="lightbox-video mfp-iframe">' : ""; ?>
              <?php if ( !empty($data->image->value) ): ?>
              <img src="<?php echo $data->image->value;  ?>" alt="<?php echo strip_tags( $data->title->value); ?>">
              <?php endif; ?>
            <?php echo (!empty($data->lightbox->value)) ? "</a>" : ""; ?>
          </div>
        </div>
      </div>
      </div>
...
$content5 = new Content5();
$arrayCode[] = $content5->data();
$arrayTemplate[] = $content5->editorTemplate();