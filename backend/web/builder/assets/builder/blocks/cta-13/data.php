...
class CTA13 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'cta-13',
      "title"      => 'CTA 13',
      "screenshot" => 'cta-13/cta-13.jpeg',
      "screenshot_size" => array( 600, 348 ),
      "template"   => '#cta-13',
  ...
  public function editorTemplate() {
    ...
    <div
      :id="`block-${id}`"
      class="icl-section icl-section--cta-13"
  ...
  static function render($id, $data, $style, $header) {
    ...
    <div
      ...
      class="icl-section icl-section--cta-13  content-<?php echo $style->content_color->value; ?>">
      <?php
        $background_style  = "";
      ...
      <div class="page-hero  <?php echo $data->alignment->value; ?>">
        <div class="<?php echo (!$style->fullwidth->value) ? 'container' : 'container-fluid'; ?>" style="padding: <?php echo implode(" ", $padding); ?>">
          <div class="columns is-vcentered <?php echo $data->reverse->value == true ? "row-reverse" : ""; ?>">
            <div class="column is-5">
              <h2  data-aos="fade-up" data-aos-detail="150" class="hero-title" style="font-size:<?php echo $data->title_size->value; ?>px;"><?php echo format_heading( $data->title->value); ?></h2>
              <div  data-aos="fade-up" data-aos-detail="300" class="hero-description"><?php echo $data->description->value; ?></div>
              <?php render_button($data->cta->value, ' data-aos="fade-up" data-aos-detail="450"'); ?>
            </div>
            <div class="column is-2"></div>
            <div class="column is-5">
              <img  data-aos="fade-up" src="<?php echo $data->image->value; ?>" alt="<?php echo strip_tags($data->title->value); ?>">
            </div>
          </div>
        </div>
      </div>
...
$cta13 = new CTA13();
$arrayCode[] = $cta13->data();
$arrayTemplate[] = $cta13->editorTemplate();