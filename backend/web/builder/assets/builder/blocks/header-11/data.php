...
class Header11 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'header-11',
      "title"      => 'Header 11',
      "screenshot" => 'header-11/header-11.jpeg',
      ...
      "category"   => 'header',
        "data" => array(
          ...
          "title" => array(
            ...
            "label" => "Judul Hero",
            "heading" => true,
            "value" => "<strong>Online Makin Lancar Deadline Bisa Dikejar</strong>"
          ),
          "title_size" => array(
            "type" => "slider",
            "label" => "Ukuran Judul",
...
$header11 = new Header11();
$arrayCode[] = $header11->data();
$arrayTemplate[] = $header11->editorTemplate();