...
class Content17 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'content-17',
      "title"      => 'Content 17',
      "screenshot" => 'content-17/content-17.jpg',
      "screenshot_size" => array( 600, 408 ),
      "template"   => '#content-17',
      "category"   => 'content',
        "data" => array(
          "image" => array(
  ...
  public function editorTemplate() {
    ...
    <div
      :id="`block-${id}`"
      class="icl-section icl-section--content-17"
  ...
  static function render($id, $data, $style) {
    ...
    <div
      ...
      class="icl-section icl-section--content-17 content-<?php echo $style->content_color->value; ?>">
      <?php
        $background_style  = "";
...
$content17 = new Content17();
$arrayCode[] = $content17->data();
$arrayTemplate[] = $content17->editorTemplate();