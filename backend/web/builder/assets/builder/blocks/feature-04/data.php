...
class Feature4 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'feature-04',
      "title"      => 'feature 4',
      "screenshot" => 'feature-04/feature-04.jpg',
      "screenshot_size" => array( 600, 355 ),
      "template"   => '#feature-04',
      "category"   => 'feature',
        "data" => array(
          "title" => array(
          ...
          "features" => array(
            ...
            "value"  => array(
              ...
              array(
                "icon" => array(
                  "type" => "icon",
                  "label" => "<strong>Feature Icon</strong>",
      ...
      <div :class="{'container': !style.fullwidth.value, 'container-fluid': style.fullwidth.value }">
        <div :class="`content-spacer`" :style="{'padding': `${style.padding.value.top}px ${style.padding.value.right}px ${style.padding.value.bottom}px ${style.padding.value.left}px`}">
          ...
          <div class="columns is-vcentered" :class="{'row-reverse': data.reverse.value == true }">
            <div class="column">
              <img :src="data.image.value" alt="" class="image-styled">
            </div>
            <div class="column">
      ...
      <div class="<?php echo (!$style->fullwidth->value) ? 'container' : 'container-fluid'; ?>">
        ...
        <div class="content-spacer" style="padding: <?php echo implode(" ", $padding); ?>">
          <div class="section-header mb4 <?php echo $data->alignment->value ?>">
            <div class="section-title" style="--font-size: <?php echo $data->title_size->value;  ?>px"><?php echo $data->title->value; ?></div>
          ...
          <div class="columns is-vcentered <?php echo $data->reverse->value == true ? 'row-reverse' : ''; ?>">
            ...
            <div class="column">
              ...
              <img class="image-styled" src="<?php echo $thumbnail_url; ?>" />
              <?php endif; ?>
            </div>
...
$feature4 = new Feature4();
$arrayCode[] = $feature4->data();
$arrayTemplate[] = $feature4->editorTemplate();