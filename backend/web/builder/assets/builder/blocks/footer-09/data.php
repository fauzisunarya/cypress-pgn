...
class Footer9 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'footer-09',
      "title"      => 'Footer 9',
      "screenshot" => 'footer-09/footer-09.jpg',
  ...
  public function editorTemplate() {
    ...
    <footer
      :id="`block-${id}`"
      :class="`icl-section icl-footer icl-footer--style-9 content-${style.content_color.value}`"
      ...
      <div :class="{'container': !style.fullwidth.value, 'container-fluid': style.fullwidth.value }">
        <div class="footer-row --top columns">
          ...
          <div class="navbar-footer-menu column">
            <a class="navbar-item is-inline-block" v-for="menu_s in data.footer_menu.value"  :href="menu_s.url.value" style="padding-left: 0;">
  ...
  static function render($id, $data, $style, $header) {
    ...
    <footer
      ...
      class="icl-section icl-footer icl-footer--style-9  content-<?php echo $style->content_color->value; ?>"
      ...
      <div class="<?php echo (!$style->fullwidth->value) ? 'container' : 'container-fluid'; ?>">
        <div class="footer-row --top columns">
          ...
          <div class="navbar-footer-menu column">
            ...
            <a class="navbar-item is-inline-block" href="<?php echo $menu_s->url->value; ?>" style="padding-left: 0;">
...
$footer9 = new Footer9();
$arrayCode[] = $footer9->data();
$arrayTemplate[] = $footer9->editorTemplate();