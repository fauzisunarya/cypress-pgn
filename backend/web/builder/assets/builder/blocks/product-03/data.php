...
class Product3 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'product-03',
      "title"      => 'Product 3',
      "screenshot" => 'product-03/product-03.jpg',
      "screenshot_size" => array( 991, 553 ),
      "template"   => '#product-03',
      "category"   => 'product',
        "data" => array(
          "column" => array(
          ...
          "title" => array(
            ...
            "label"           => 'Judul',
            "heading"         => true,
            "value"           => '<strong>Produk Terlaris</strong>',
          ),
          "title_size" => array(
            "type"            => 'slider',
            "label"           => 'Ukuran Judul',
        ...
        "style" => array(
          ...
          "background" => array(
            ...
            "value"           => array(
              ...
              "backgroundImage"      => "https://images.unsplash.com/photo-1415025148099-17fe74102b28?ixlib=rb-1.2.1&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=1080&fit=max&ixid=eyJhcHBfaWQiOjk3MjkwfQ",
  ...
  public function editorTemplate() {
    ...
    <div
      :id="`block-${id}`"
      class="icl-section icl-section--product-3"
        ...
        <div :class="`content-spacer`" :style="{'padding': `${style.padding.value.top}px ${style.padding.value.right}px ${style.padding.value.bottom}px ${style.padding.value.left}px`}">
          ...
          <Sortable class="product-grid columns is-centered" v-model="data.products.value">
            <SortableItem :class="`column is-${12 / data.column.value}`" v-for="(item, index) in data.products.value"  :key="`item-${index}`" :list="data.products.value" :index="index">
              <div class="icl-product icl-product--style-3">
                <div class="icl-product__card">
                  <div class="icl-product__header">
                    <small class="icl-product__top_title"><InlineEditor v-model="item.top_title.value"/></small>
  ...
  static function render($id, $data, $style) {
    ...
    <div
      ...
      class="icl-section icl-section--product-3 content-<?php echo $style->content_color->value; ?>">
      <?php
        $background_style  = "";
            ...
            <?php foreach( $data->products->value as $item ): ?>
              <div class="column is-<?= 12 / $data->column->value; ?>">
                <div class="icl-product icl-product--style-3">
                  <div class="icl-product__card">
                    <div class="icl-product__header">
                      <small class="icl-product__top_title"><?php echo $item->top_title->value; ?></small>
                      <h2 class="icl-product__title"><?php echo $item->title->value;  ?></h2>
                    </div>
                    <div class="icl-product__image">
                      <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" data-src="<?php echo $item->image->value; ?>" alt="<?php echo strip_tags($item->title->value); ?>" />
                    </div>
                    <div class="icl-product__detail">
...
$arrayCode[] = $product3->data();
$arrayTemplate[] = $product3->editorTemplate();