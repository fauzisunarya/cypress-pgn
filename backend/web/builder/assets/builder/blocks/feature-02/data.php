...
class Feature2 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'feature-02',
      "title"      => 'feature 2',
      "screenshot" => 'feature-02/feature-02.jpg',
  ...
  public function editorTemplate() {
    ...
    <div
      :id="`block-${id}`"
      class="icl-section icl-section--feature-2"
      ...
      <div :class="{'container': !style.fullwidth.value, 'container-fluid': style.fullwidth.value }">
        <div :class="`content-spacer`" :style="{'padding': `${style.padding.value.top}px ${style.padding.value.right}px ${style.padding.value.bottom}px ${style.padding.value.left}px`}">
          ...
          <Sortable class="feature-grid-02 columns" v-model="data.features.value">
            <SortableItem class="column is-4" v-for="(item, index) in data.features.value" :key="`item-${index}`" :list="data.features.value" :index="index">
              <div class="icl-feature icl-feature--style-2">
  ...
  static function render($id, $data, $style) {
    ...
    <div
      ...
      class="icl-section icl-section--feature-2 content-<?php echo $style->content_color->value; ?>">
      <?php
        $background_style  = "";
      ...
      <div class="<?php echo (!$style->fullwidth->value) ? 'container' : 'container-fluid'; ?>">
        ...
        <div class="content-spacer" style="padding: <?php echo implode(" ", $padding); ?>">
          ...
          <div class="feature-grid-02 columns">
...
$arrayCode[] = $feature2->data();
$arrayTemplate[] = $feature2->editorTemplate();
