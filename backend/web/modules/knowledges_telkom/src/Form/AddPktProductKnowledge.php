...
class AddPktProductKnowledge extends FormBase
{
    public function getFormId()
    {
        return 'add_pkt_product_knowledge';
    }
    ...
    public function buildForm(array $form, FormStateInterface $form_state)
    {
        ...
        $form['category'] = [
            ...
            '#ajax' => [
                ...
                'wrapper' => 'pkt_pknowledge_container'
            ]
        ];
        ...
        $form['pkt_pknowledge_container'] = [
            '#type' => 'container',
            '#attributes' => [
                'id' => 'pkt_pknowledge_container',
            ],
        ];

        $form['pkt_pknowledge_container']['pkt_pknowledge_parent'] = [
            '#type' => 'entity_autocomplete',
    ...
    public function validateForm(array &$form, FormStateInterface $form_state)
    {
        ...
        $id = $form_data['pkt_pknowledge_parent'];
        $data = Node::load($id);
    ...
    public function submitForm(array &$form, FormStateInterface $form_state)
    {
        ...
        $form_data = $form_state->getValues();
        $pkt_pknowledge_parent = $form_data['pkt_pknowledge_parent'];
        $destination = !empty($form_data['destination_hidden']) ? $form_data['destination_hidden'] : "/paket/{$pkt_id}/product-knowledges";
        $response = new RedirectResponse(getenv('APP_URL'). "/node/add/paket_product_knowledge?destination={$destination}&pkt_id={$pkt_id}&pkt_pknowledge_parent={$pkt_pknowledge_parent}");
        $response->send();
    }

    public function handleFilter(array $form, FormStateInterface $form_state)
    {
        return $form['pkt_pknowledge_container'];
    }
}
