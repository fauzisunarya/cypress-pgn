...
class AddPctProductKnowledge extends FormBase
{
    public function getFormId()
    {
        return 'add_pct_product_knowledge';
    }
    ...
    public function buildForm(array $form, FormStateInterface $form_state)
    {
        ...
        $form['category'] = [
            ...
            '#ajax' => [
                ...
                'wrapper' => 'pct_pknowledge_container'
            ]
        ];
        ...
        $form['pct_pknowledge_container'] = [
            '#type' => 'container',
            '#attributes' => [
                'id' => 'pct_pknowledge_container',
            ],
        ];

        $form['pct_pknowledge_container']['pct_pknowledge_parent'] = [
            '#type' => 'entity_autocomplete',
    ...
    public function validateForm(array &$form, FormStateInterface $form_state)
    {
        ...
        $id = $form_data['pct_pknowledge_parent'];
        $data = Node::load($id);
    ...
    public function submitForm(array &$form, FormStateInterface $form_state)
    {
        ...
        $form_data = $form_state->getValues();
        $pct_pknowledge_parent = $form_data['pct_pknowledge_parent'];
        $destination = !empty($form_data['destination_hidden']) ? $form_data['destination_hidden'] : "/product-catalog/{$pct_id}/product-knowledges";
        $response = new RedirectResponse(getenv('APP_URL'). "/node/add/product_catalog_product_knowledg?destination={$destination}&pct_id={$pct_id}&pct_pknowledge_parent={$pct_pknowledge_parent}");
        $response->send();
    }

    public function handleFilter(array $form, FormStateInterface $form_state)
    {
        return $form['pct_pknowledge_container'];
    }
}
