...
export default function FormDialog({ handleClose, open, maxWidth, isLoading, title, children, handleSubmit, handleReject, cancelButtonLabel, rejectButtonLabel, submitButtonLabel, resetButtonLabel, deleteButtonLabel, reset, message, handleDisabled, handleDelete }: any) {
    return (
        <BasicDialog
...
function Action({ handleClose, message, isLoading, cancelButtonLabel, rejectButtonLabel, submitButtonLabel, resetButtonLabel, handleSubmit,handleReject, reset, handleDisabled, deleteButtonLabel, handleDelete }: any) {
            ...
            <Grid container>
                ...
                <Grid item xs={6}>
                    <Box display={'flex'} justifyContent={'right'} alignItems={'right'}>
                        { deleteButtonLabel &&
                            <Button onClick={handleDelete}>{deleteButtonLabel}</Button>
                        }
