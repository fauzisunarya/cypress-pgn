...
class WibsHelper {
  ...
  public static function detail(&$variables=[], &$node=null) {
    ...
    include_custom_functions('/wibs/template/', 'template_pricing');
  
    (new TemplatePricingWibs)->get_list($variables, $node);
  ...
  public static function page_edit(&$variables, Node $node ) {
    ...
    foreach ($data['data'] as $key => $value) {
      ...
      $data['data'][$key]['disabled'] = in_array($key, WibsHelper::field_disabled_edit()) ? true : false;
    }
