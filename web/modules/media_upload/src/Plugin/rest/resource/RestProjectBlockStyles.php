 ...
 * @RestResource(
 *   id = "custom_rest_project_block_styles",
 *   label = @Translation("Custom Rest Project Block Styles"),
 *   uri_paths = {
 *     "canonical" = "/api/v1/project/block-styles",
 *   }
 * )
 */
class RestProjectBlockStyles extends ResourceBase {
  /**
  ...
  public function get() {
    ...
    foreach ($arrayCode as $code) {
      ...
      $block_id = $code['blockID'];
      $block_class_name = ucfirst(str_replace(array('-0', '-'), '', $block_id));

      $styles .= $block_class_name::renderCSS();
    }
