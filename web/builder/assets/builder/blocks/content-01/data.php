...
class Content1 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'content-01',
      "title"      => 'Content 1',
      "screenshot" => 'content-01/content-01.jpg',
      "screenshot_size" => array( 600, 227 ),
      "template"   => '#content-01',
      "category"   => 'content',
        "data" => array(
  ...
  static function render($id, $data, $style) {
    ...
    <div
      ...
      <div class="content-spacer <?php echo $data->alignment->value; ?>" style="padding: <?php echo implode(" ", $padding); ?>">
        ...
        <span data-aos="fade-up" data-aos-delay="300" class="section-subtitle"><?php echo $data->subtitle->value;  ?></span>
      </div>
      </div>
    </div>
  <?php
...
$arrayCode[] = $content1->data();
$arrayTemplate[] = $content1->editorTemplate();