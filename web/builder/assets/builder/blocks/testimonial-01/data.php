...
class Testimonial1 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'testimonial-01',
      "title"      => 'Testimonial 1',
      "screenshot" => 'testimonial-01/testimonial-01.jpg',
      "screenshot_size" => array( 600, 275 ),
      "template"   => '#testimonial-01',
  ...
  public function editorTemplate() {
    ...
    <div
      :id="`block-${id}`"
      class="icl-section icl-section--testimonial-1"
      ...
      <div :class="{'container': !style.fullwidth.value, 'container-fluid': style.fullwidth.value }">
        <div :class="`content-spacer`" :style="{'padding': `${style.padding.value.top}px ${style.padding.value.right}px ${style.padding.value.bottom}px ${style.padding.value.left}px`}">
          <carousel :id="id" :items="1" :controls="data.controls.value" :nav="data.nav.value" :slides="data.testimonials.value">
            <div class="slide icl-testimonial icl-testimonial--style-1" v-for="item in data.testimonials.value">
  ...
  static function render($id, $data, $style) {
    ...
    <div
      ...
      class="icl-section icl-section--testimonial-1 content-<?php echo $style->content_color->value; ?>">
      <?php
        $background_style  = "";
      ...
      <div class="<?php echo (!$style->fullwidth->value) ? 'container' : 'container-fluid'; ?>">
        <div class="content-spacer" style="padding: <?php echo implode(" ", $padding); ?>">
          <div class="icl-carousel" data-items="1" data-controls="<?php echo $data->controls->value; ?>" data-nav="<?php echo $data->nav->value; ?>">
            <?php foreach( $data->testimonials->value as $item ): ?>
              <div class="slide icl-testimonial icl-testimonial--style-1">
                <div class="icl-testimonial__card">
...
$testimonial1 = new Testimonial1();
$arrayCode[] = $testimonial1->data();
$arrayTemplate[] = $testimonial1->editorTemplate();