...
class Pricing7 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'pricing-07',
      "title"      => 'Pricing 7',
      "screenshot" => 'pricing-07/pricing-07.jpg',
      "screenshot_size" => array( 944, 561 ),
      "template"   => '#pricing-07',
      "category"   => 'pricing',
        "data" => array(
          "title" => array(
            ...
            "value"  => array(
              array(
                ...
                "content" => array(
                  "type" => "wyswyg",
                  "label" => "Content",
                  "value" => "<ul><li>Nobis tempore</li><li>Numquam impedit</li><li>Recusandae libero</li><li>Temporibus quibusdam</li><li>Obcaecati deleniti</li></ul>"
                ),
          ...
          <Sortable class="pricing-grid columns flex-wrap is-centered" v-model="data.pricing.value">
            <SortableItem :class="`column is-${12/data.column.value || 3}`" v-for="(item, index) in data.pricing.value" :key="`item-${index}`" :list="data.pricing.value" :index="index">
              <div class="icl-pricing icl-pricing--style-2"  :class="{'is-featured': item.featured.value }">
                ...
                <div class="icl-pricing__header box has-text-white" :style="{
                  ...
                  <div class="icl-pricing__header-detail">
                    ...
                    <small class="icl-pricing__subtitle" style="font-size: 30px; font-weight: 700;"><InlineEditor v-model="item.title.value" /></small>
                  </div>
                </div>
            ...
            <?php foreach( $data->pricing->value as $item ): ?>
              <div class="column is-<?php echo 12 / get_value($data, "column", 3); ?>">
                <div class="icl-pricing icl-pricing--style-2 <?php echo $item->featured->value ? 'is-featured': ''; ?>">
                  ...
                  <div class="icl-pricing__header box has-text-white" style="background-color: <?php echo $item->background->value; ?>;">
                    <div class="icl-pricing__header-detail">
                      <small class="icl-pricing__subtitle"><?php echo $item->subtitle->value;  ?></small>
                      <small class="icl-pricing__subtitle" style="font-size: 30px; font-weight: 700;"><?php echo $item->title->value;  ?></small>
                    </div>
                  </div>
...
$pricing7 = new Pricing7();
$arrayCode[] = $pricing7->data();
$arrayTemplate[] = $pricing7->editorTemplate();