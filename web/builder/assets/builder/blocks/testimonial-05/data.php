...
class Testimonial5 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'testimonial-05',
      "title"      => 'Testimonial 5',
      "screenshot" => 'testimonial-05/testimonial-05.jpg',
      "screenshot_size" => array( 600, 290 ),
      "template"   => '#testimonial-05',
      "category"   => 'testimonial',
        "data" => array(
          ...
          "subtitle" => array(
            "type"            => 'wyswyg',
            "label"           => 'Sub Judul',
            "value"           => 'Fast and easy page builder',
          ),
          "alignment" => array(
            "type"            => 'radio-icon',
            "label"           => 'Rata Teks',
  ...
  public function editorTemplate() {
    ...
    <div
      :id="`block-${id}`"
      class="icl-section icl-section--testimonial-5"
      ...
      <div :class="{'container': !style.fullwidth.value, 'container-fluid': style.fullwidth.value }">
        <div :class="`content-spacer`" :style="{'padding': `${style.padding.value.top}px ${style.padding.value.right}px ${style.padding.value.bottom}px ${style.padding.value.left}px`}">
          ...
          <masonry-grid :items="data.testimonials.value">
            <div class="slide icl-testimonial icl-testimonial--style-5" v-for="(item, index) in data.testimonials.value" :key="`item-${index}`">
  ...
  static function render($id, $data, $style) {
    ...
    <div
      ...
      class="icl-section icl-section--testimonial-5 content-<?php echo $style->content_color->value; ?>">
      <?php
        $background_style  = "";
      ...
      <div class="content-spacer" style="padding: <?php echo implode(" ", $padding); ?>">
        ...
        <div class="masonry-grid">
          <?php foreach( $data->testimonials->value as $item ): ?>
            <div class="slide icl-testimonial icl-testimonial--style-5">
              <div class="icl-testimonial__card">
...
$testimonial5 = new Testimonial5();
$arrayCode[] = $testimonial5->data();
$arrayTemplate[] = $testimonial5->editorTemplate();