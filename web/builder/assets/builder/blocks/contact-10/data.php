...
class Contact10 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'contact-10',
      "title"      => 'Contact 10',
      "screenshot" => 'contact-10/contact-10.jpg',
      "screenshot_size" => array( 946, 585 ),
      "template"   => '#contact-10',
      "category"   => 'contact',
        "data" => array(
          "title" => array(
          ...
          "title2" => array(
            ...
            "label"           => 'Judul 2',
            "heading"         => true,
            "value"           => '<strong>Social Media</strong>',
          ),
          "title_size2" => array(
            "type"            => 'slider',
            "label"           => 'Ukuran Judul 2',
            "value"           => 36,
            "min"             => 18,
            "max"             => 72,
            "horizontal" => true,
          ...
          "subtitle2" => array(
            "type"            => 'wyswyg',
            "label"           => 'Sub Judul 2',
            "value"           => 'Want to connect with us? Follow our social media to get our latest info',
          ),
          "alignment2" => array(
            "type"            => 'radio-icon',
            "label"           => 'Rata Teks 2',
  ...
  public function editorTemplate() {
    ...
    <div
      :id="`block-${id}`"
      class="icl-section icl-section--contact-9"
          ...
          <div class="contact-panel">
            ...
            <Sortable v-model="data.contact.value" class="columns flex-wrap is-centered">
              <SortableItem class="column is-4" v-for="(item, index) in data.contact.value" :key="`item-${index}`" :list="data.contact.value" :index="index">
                <div class="icl-contact icl-contact--style-1" style="margin-top: -25px;">
                  <div class="icl-contact__card" style="display: flex; flex-direction: column; align-items: center;">
            ...
            <!-- title & subtitle 2 -->
            <div :class="`section-header mb4 ${data.alignment2.value}`">
              <div class="section-title" :style="`--font-size:${data.title_size2.value}px`"><InlineEditor v-model="data.title2.value"/></div>
              <span class="section-subtitle" ><InlineEditor v-model="data.subtitle2.value" /></span>
            </div>

            <!-- multi sosmed button -->
            <div class="navbar-social-icons navbar-social-icons-contact-10 is-pulled-left" style="margin-top: -25px; width: 100%;">
  ...
  static function render($id, $data, $style) {
    ...
    <div
      ...
      class="icl-section icl-section--contact-9 content-<?php echo $style->content_color->value; ?>">
      <?php
        $background_style  = "";
      ...
      <div class="content-spacer" style="padding: <?php echo implode(" ", $padding); ?>">
        <div class="contact-panel">
                ...
                <div class="icl-contact icl-contact--style-1" style="margin-top: -25px;">
                  <div class="icl-contact__card" style="display: flex; flex-direction: column; align-items: center;">
                    <?php
                      ...
                      ";
                    ?>
                    <div class="icl-contact__icon" style="<?php echo $icon_background_style; echo $icon_color ? "color:{$icon_color};": ""; echo isset($data->icon_size) && $icon_size ? "font-size:{$data->icon_size->value}px;" : ""; ?>"><?php echo get_font_awesome_svg($item->icon->value); ?></div>
          ...
          <!-- title & subtitle 2 -->
          <div class="section-header mb4 <?php echo $data->alignment2->value ?>">
            <h2 class="section-title" style="--font-size: <?php echo $data->title_size2->value;  ?>px"><?php echo format_heading( $data->title2->value); ?></h2>
            <span class="section-subtitle"><?php echo $data->subtitle2->value; ?></span>
          </div>
...
$contact10 = new Contact10();
$arrayCode[] = $contact10->data();
$arrayTemplate[] = $contact10->editorTemplate();