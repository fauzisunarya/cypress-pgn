...
class Pricing1 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'pricing-01',
      "title"      => 'Pricing 1',
      "screenshot" => 'pricing-01/pricing-01.jpg',
      "screenshot_size" => array( 600, 277 ),
      "template"   => '#pricing-01',
      "category"   => 'pricing',
        "data" => array(
          "title" => array(
    ...
    <div
      ...
      <div :class="{'container': !style.fullwidth.value, 'container-fluid': style.fullwidth.value }">
        <div :class="`content-spacer`" :style="{'padding': `${style.padding.value.top}px ${style.padding.value.right}px ${style.padding.value.bottom}px ${style.padding.value.left}px`}">
          ...
          <Sortable class="pricing-grid columns flex-wrap is-vcentered is-centered" v-model="data.pricing.value">
            <SortableItem :class="`column is-${12 / data.column.value || 3}`" v-for="(item, index) in data.pricing.value" :key="`item-${index}`" :list="data.pricing.value" :index="index">
              <div class="icl-pricing icl-pricing--style-1" :class="{'is-featured': item.featured.value }">
  ...
  static function render($id, $data, $style) {
    ...
    <div
      ...
      class="icl-section icl-section--pricing-1 content-<?php echo $style->content_color->value; ?>">
      <?php
        $background_style  = "";
      ...
      <div class="<?php echo (!$style->fullwidth->value) ? 'container' : 'container-fluid'; ?>">
        ...
        <div class="content-spacer" style="padding: <?php echo implode(" ", $padding); ?>">
          ...
          <div class="pricing-grid columns flex-wrap is-vcentered is-centered">
            <?php foreach( $data->pricing->value as $item ): ?>
              <div class="column is-<?php echo 12 / $data->column->value; ?>">
                <div class="icl-pricing icl-pricing--style-1 <?php echo $item->featured->value ? 'is-featured': ''; ?>">
...
$arrayCode[] = $pricing1->data();
$arrayTemplate[] = $pricing1->editorTemplate();