...
class Header3 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'header-03',
      "title"      => 'Header 3',
      "screenshot" => 'header-03/header-03.jpeg',
      "screenshot_size" => array( 600, 82 ),
      "template"   => '#header-03',
      "category"   => 'header',
        "data" => array(
          "logo" => array(
          ...
          "topbar_text" => array(
            "type" => "wyswyg",
            "label" => "Topbar Text",
            "value" => "Contact us <a href=\"#\">+62-873-465</a>"
          ),
          "social" => array(
            "type" => "repeatable",
            "label" => "Social icons",
        ...
        "style" => array(
          ...
          "topnav_background_color" => array(
            "type" => "color",
            "horizontal" => true,
            "label" => "Top nav background",
            "value" => "#495057"
          ),
          "topnav_content_color" => array(
            "type" => "select",
            "horizontal" => true,
            "label" => "Top nav color",
            "value" => "light",
  ...
  public function editorTemplate() {
    ...
    <header
      :id="`block-${id}`"
      class="icl-header icl-header--style-3">
      <div class="navbar-top is-hidden-mobile" :style="{'backgroundColor': style.topnav_background_color.value}" :class="`content-${style.topnav_content_color.value}`">
        <div :class="{'container': !style.fullwidth.value, 'container-fluid': style.fullwidth.value }">
          <div class="columns">
            <div class="column">
              <div v-html="data.topbar_text.value"></div>
            </div>
            <div class="column flex-end is-flex">
  ...
  static function render($id, $data, $style, $header) {
    ...
    <header
      ...
      class="icl-header icl-header--style-3">
      <div
        class="navbar-top is-hidden-mobile content-<?php echo $style->topnav_content_color->value; ?>"
        style="background-color: <?php echo $style->topnav_background_color->value; ?>">
        <?php echo (!$style->fullwidth->value) ? "<div class=\"container\">" : ""; ?>
          <div class="columns">
            <div class="column">
              <div><?php echo $data->topbar_text->value; ?></div>
            </div>
            <div class="column flex-end is-flex">
              <div class="navbar-social-icons">
      ...
      <div
        class="navbar-main"
        class="content-<?php echo $style->content_color->value; ?>"
...
$header3 = new Header3();
$arrayCode[] = $header3->data();
$arrayTemplate[] = $header3->editorTemplate();