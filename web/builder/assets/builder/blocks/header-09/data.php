...
class Header9 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'header-09',
      "title"      => 'Header 9',
      "screenshot" => 'header-09/header-09.jpeg',
        ...
        "style" => array(
          ...
          "background" => array(
            ...
            "value"           => array(
              ...
              "backgroundImage"      => $this->base_url . 'builder/assets/builder/blocks-assets/imgs/photos/nature.jpeg',
  ...
  public function editorTemplate() {
    ...
    <header
      :id="`block-${id}`"
      class="icl-header icl-header--style-9"
  ...
  static function render($id, $data, $style, $header) {
    ...
    <header
      ...
      class="icl-header icl-header--style-9  content-<?php echo $style->content_color->value; ?>">
      <?php
        $background_style  = "";
...
$header9 = new Header9();
$arrayCode[] = $header9->data();
$arrayTemplate[] = $header9->editorTemplate();