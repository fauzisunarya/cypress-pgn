...
class Product6 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'product-06',
      "title"      => 'Product 6',
      "screenshot" => 'product-06/product-06.jpeg',
      ...
      "category"   => 'product',
        "data" => array(
          "title" => array(
            ...
            "label"           => 'Judul',
            "heading"         => true,
            "value"           => '<strong>Deluxe Room</strong>',
          ),
          "title_size" => array(
            "type"            => 'slider',
            "label"           => 'Ukuran Judul',
          ...
          "content" => array(
            "type"            => 'wyswyg',
            "label"           => 'Konten',
            "value"           => '<p>Soluta velit voluptatem doloribus dolore molestiae dolor natus labore sunt delectus, est deserunt officia adipisci nihil iure modi.</p><ul><li>Private Bathroom</li><li>King size bed</li><li>Free Minibar</li><li>Breakfast & Dinner</li></ul>',
          ),
          "price_unit" => array(
            "type"            => 'text',
            "label"           => 'Price Unit',
        ...
        <div class="content-spacer" style="padding: <?php echo implode(" ", $padding); ?>">
          <div class="columns is-vcentered <?php echo $data->reverse->value == true ? "row-reverse" : ""; ?>">
            <div class="column is-4">
              ...
              <div data-aos="fade-up" data-aos-delay="150" class="mt2 mb3"><?php echo $data->content->value;  ?></div>
...
$product6 = new Product6();
$arrayCode[] = $product6->data();
$arrayTemplate[] = $product6->editorTemplate();