...
class Sosmed3 {
  ...
  public function data() {
    ...
    return array(
      ...
      "screenshot" => 'sosmed-03/sosmed-03.jpg',
      "screenshot_size" => array( 1076, 216 ),
      "template"   => '#sosmed-03',
      "category"   => 'sosmed',
        "data" => array(
          "products" => array(
  ...
  public function editorTemplate() {
    ...
    <div
      :id="`block-${id}`"
      class="icl-section icl-section--sosmed-03"
      ...
      <div :class="{'container': !style.fullwidth.value, 'container-fluid': style.fullwidth.value }">
        <div class="content-spacer has-text-centered" :style="{'padding': `${style.padding.value.top}px ${style.padding.value.right}px ${style.padding.value.bottom}px ${style.padding.value.left}px`}">
          <div
            ...
            class="columns is-vcentered is-variable is-6">
  ...
  static function render($id, $data, $style) {
    ...
    <div
      ...
      class="icl-section icl-section--sosmed-03 content-<?php echo $style->content_color->value; ?>">
      <?php
        $background_style  = "";
...
$Sosmed3 = new Sosmed3();
$arrayCode[] = $Sosmed3->data();
$arrayTemplate[] = $Sosmed3->editorTemplate();