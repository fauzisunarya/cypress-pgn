...
class Content15 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'content-15',
      "title"      => 'Content 15',
      "screenshot" => 'content-15/content-15.jpg',
      ...
      "category"   => 'content',
        "data" => array(
          ...
          "col2" => array(
            "type" => "repeatable",
            "label" => "Judul dan Detail Kolom 2",
            "item_title" => "question",
            "settings"=> array(
              "question" => array(
                  "type" => "text",
        ...
        <div :class="`content-spacer ${data.alignment.value}`" :style="{'padding': `${style.padding.value.top}px ${style.padding.value.right}px ${style.padding.value.bottom}px ${style.padding.value.left}px`}">
          ...
          <div class="columns">
            <div class="column is-6">
              <div class="accordion-item" v-for="qa in data.col1.value">
                <h3 class="accordion-title" ><InlineEditor v-model="qa.question.value" /></h3>
                <div class="accordion-content" ><InlineEditor v-model="qa.answer.value" /></div>
              </div>
            </div>
            <div class="column is-6">
              <div class="accordion-item" v-for="qa in data.col2.value">
                <h3 class="accordion-title" ><InlineEditor v-model="qa.question.value" /></h3>
                <div class="accordion-content" ><InlineEditor v-model="qa.answer.value" /></div>
              </div>
            </div>
  ...
  static function render($id, $data, $style) {
    ...
    <div
      ...
      <div class="content-spacer <?php echo $data->alignment->value; ?>" style="padding: <?php echo implode(" ", $padding); ?>">
        ...
        <div class="columns">
          <div class="column is-6">
            <?php foreach( $data->col1->value as $qa): ?>
            <div class="accordion-item">
              <h3 class="accordion-title"><?php echo $qa->question->value; ?></h3>
              <div class="accordion-content"><?php echo $qa->answer->value; ?></div>
            </div>
            <?php endforeach; ?>
          </div>
          <div class="column is-6">
            <?php foreach( $data->col2->value as $qa): ?>
            <div class="accordion-item">
              <h3 class="accordion-title"><?php echo $qa->question->value; ?></h3>
              <div class="accordion-content"><?php echo $qa->answer->value; ?></div>
            </div>
...
$content15 = new Content15();
$arrayCode[] = $content15->data();
$arrayTemplate[] = $content15->editorTemplate();