...
class Team8 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'team-08',
      "title"      => 'Team 8',
      "screenshot" => 'team-08/team-08.jpg',
      "screenshot_size" => array( 763, 602 ),
      "template"   => '#team-08',
      "category"   => 'team',
        "data" => array(
          "title" => array(
          ...
          <div class="icl-team-list icl-team-list--alt">
            <div class="icl-team icl-team--style-2" v-for="item in data.teams.value">
              <div class="icl-team__card">
                <img class="icl-team__avatar angga-team-avatar" :src="item.avatar.value">
                <div class="icl-team__detail angga-icl-team-detail">
                  ...
                  <!-- multi sosmed button -->
                  <div class="navbar-social-icons" style="margin-bottom: 10px; justify-content: start;">
          ...
          <?php foreach( $data->teams->value as $item ): ?>
            <div class="icl-team icl-team--style-2">
              <div class="icl-team__card">
                ...
                <img class="icl-team__avatar angga-team-avatar" src="<?php echo $thumbnail_url;?>">
                <div class="icl-team__detail angga-icl-team-detail">
...
$team8 = new Team8();
$arrayCode[] = $team8->data();
$arrayTemplate[] = $team8->editorTemplate();