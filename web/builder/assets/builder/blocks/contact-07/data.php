...
class Contact7 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'contact-07',
      "title"      => 'Contact 7',
      "screenshot" => 'contact-07/contact-07.jpg',
      "screenshot_size" => array( 600, 365 ),
      "template"   => '#contact-07',
      "category"   => 'contact',
        "data" => array(
          "title" => array(
  ...
  public function editorTemplate() {
    ...
    <div
      :id="`block-${id}`"
      class="icl-section icl-section--contact-7"
      ...
      <div :class="{'container': !style.fullwidth.value, 'container-fluid': style.fullwidth.value }">
        <div :class="`content-spacer`" :style="{'padding': `${style.padding.value.top}px ${style.padding.value.right}px ${style.padding.value.bottom}px ${style.padding.value.left}px`}">
          <div class="columns is-variable is-5" :class="{'row-reverse': data.reverse.value == true }">
  ...
  static function render($id, $data, $style) {
    ...
    <div
      ...
      class="icl-section icl-section--contact-7 content-<?php echo $style->content_color->value; ?>">
      <?php
        $background_style  = "";
      ...
      <div class="<?php echo (!$style->fullwidth->value) ? 'container' : 'container-fluid'; ?>">
        <div class="content-spacer" style="padding: <?php echo implode(" ", $padding); ?>">
          <div class="columns is-variable is-5 <?php echo $data->reverse->value == true ? "row-reverse" : ""; ?>">
            <div class="column is-6">
...
$contact7 = new Contact7();
$arrayCode[] = $contact7->data();
$arrayTemplate[] = $contact7->editorTemplate();