...
class Product11 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'product-11',
      "title"      => 'Product 11',
      "screenshot" => 'product-11/product-11.jpg',
      "screenshot_size" => array( 600, 394 ),
      "template"   => '#product-11',
      "category"   => 'product',
        "data" => array(
          "top_title" => array(
...
$product11 = new Product11();
$arrayCode[] = $product11->data();
$arrayTemplate[] = $product11->editorTemplate();