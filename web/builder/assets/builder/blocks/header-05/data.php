...
class Header5 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'header-05',
      "title"      => 'Header 5',
      "screenshot" => 'header-05/header-05.jpeg',
      "screenshot_size" => array( 600, 81 ),
      "template"   => '#header-05',
      "category"   => 'header',
        "data" => array(
          "logo" => array(
          ...
          <div class="columns">
            ...
            <div class="column flex-end is-flex">
              <div class="navbar-secondary-menu">
                <a class="navbar-item" v-for="menu_s in data.secondary_menu.value"  :href="menu_s.url.value">
...
$header5 = new Header5();
$arrayCode[] = $header5->data();
$arrayTemplate[] = $header5->editorTemplate();