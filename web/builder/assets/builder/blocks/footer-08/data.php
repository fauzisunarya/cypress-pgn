...
class Footer8 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'footer-08',
      "title"      => 'Footer 8',
      "screenshot" => 'footer-08/footer-08.jpg',
      "screenshot_size" => array( 600, 98 ),
      "template"   => '#footer-08',
      "category"   => 'footer',
        "data" => array(
          "logo" => array(
          ...
          "additional_text" => array(
            ...
            "horizontal"      => true,
            "label"           => 'Teks Tambahan',
            "value"           => "Telkom Indonesia adalah situs untuk membuat halaman web dengan cepat dan mudah",
          ),
          "social" => array(
            "type" => "repeatable",
            "label" => "Social Icons",
  ...
  public function editorTemplate() {
    ...
    <footer
      :id="`block-${id}`"
      :class="`icl-section icl-footer icl-footer--style-8 content-${style.content_color.value}`"
  ...
  static function render($id, $data, $style, $header) {
    ...
    <footer
      ...
      class="icl-section icl-footer icl-footer--style-8  content-<?php echo $style->content_color->value; ?>"
...
$footer8 = new Footer8();
$arrayCode[] = $footer8->data();
$arrayTemplate[] = $footer8->editorTemplate();