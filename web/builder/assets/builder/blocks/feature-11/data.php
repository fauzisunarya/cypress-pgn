...
class Feature11 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'feature-11',
      "title"      => 'feature 11',
      "screenshot" => 'feature-11/feature-11.jpg',
      "screenshot_size" => array( 600, 274 ),
      "template"   => '#feature-11',
      "category"   => 'feature',
        "data" => array(
          "title" => array(
          ...
          "content" => array(
            "type"            => 'wyswyg',
            "label"           => 'Sub Judul',
            "value"           => '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Odio perferendis blanditiis nemo, inventore! Tenetur, corporis atque necessitatibus ipsa tempore dolorum a illo. Eum quas sit neque facere, error necessitatibus fugit!</p>',
          ),
          ...
          "title_2" => array(
            ...
            "label"           => 'Judul',
            "heading"         => true,
            "value"           => '<strong>Why Choose Us</strong>',
          ),
          "title_2_size" => array(
            "type"       => 'slider',
            "label"      => 'Ukuran Judul',
  ...
  public function editorTemplate() {
    ...
    <div
      ...
      <div class="icl-section__bg" :style="{
        ...
        <div class="columns is-variable is-8 bg-half-wrapper" :class="{'row-reverse': data.reverse.value == true }">
      ...
      <div :class="{'container': !style.fullwidth.value, 'container-fluid': style.fullwidth.value }">
        <div :class="`content-spacer`" :style="{'padding': `${style.padding.value.top}px ${style.padding.value.right}px ${style.padding.value.bottom}px ${style.padding.value.left}px`}">
          ...
          <div class="columns is-variable is-8 is-vcentered" :class="{'row-reverse': data.reverse.value == true }">
            ...
            <div class="column">
              <h2 :class="`section-title mb3 ${data.alignment_2.value}`" :style="`--font-size:${data.title_2_size.value}px`"><InlineEditor v-model="data.title_2.value" /></h2>
              <div class="feature-list">
                <div class="icl-feature icl-feature--style-4" v-for="(item, index) in data.features.value" :key="`item-${index}`">
  ...
  static function render($id, $data, $style) {
    ...
    <div
      ...
      <div class="icl-section__bg" style="<?php echo $background_style; ?>">
        <div class="columns is-variable is-8 bg-half-wrapper <?php echo $data->reverse->value == true ? "row-reverse" : ""; ?>">
          <div class="column is-half">
            ...
            <div class="bg-half" style="background-image: url(<?php echo $thumbnail_url;  ?>)"></div>
          </div>
          <div class="column is-half"></div>
        </div>
      ...
      <div class="<?php echo (!$style->fullwidth->value) ? 'container' : 'container-fluid'; ?>">
        ...
        <div class="content-spacer" style="padding: <?php echo implode(" ", $padding); ?>">
          ...
          <div class="columns is-variable is-8 is-vcentered <?php echo $data->reverse->value == true ? 'row-reverse' : ''; ?>">
            ...
            <div class="column">
              <h2 class="section-title mb3 <?php echo $data->alignment_2->value ?>" style="--font-size: <?php echo $data->title_2_size->value;  ?>px"><?php echo $data->title_2->value; ?></h2>
              <div class="feature-list">
                <?php foreach( $data->features->value as $item ): ?>
                  <div class="icl-feature icl-feature--style-4">
...
$feature11 = new Feature11();
$arrayCode[] = $feature11->data();
$arrayTemplate[] = $feature11->editorTemplate();