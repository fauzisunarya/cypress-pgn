...
class Feature8 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'feature-08',
      "title"      => 'feature 8',
      "screenshot" => 'feature-08/feature-08.jpg',
      ...
      "category"   => 'feature',
        "data" => array(
          ...
          "image" => array(
            "type" => "image",
            "label" => "Feature Image",
            "value" => $this->base_url . 'builder/assets/builder/blocks-assets/imgs/photos/phone-half.png'
          ),
  ...
  public function editorTemplate() {
    ...
    <div
      :id="`block-${id}`"
      class="icl-section icl-section--feature-8"
          ...
          <div class="columns is-vcentered is-variable is-8">
            <div class="column">
              <div class="feature-list">
                <div class="icl-feature icl-feature--style-8" v-for="(item, index) in data.features_1.value" :key="`item-${index}`" :style="{marginBottom: `${data.spacing.value}px`}">
            ...
            <div class="column">
              <div class="feature-list">
                <div class="icl-feature icl-feature--style-8" v-for="(item, index) in data.features_2.value" :key="`item-${index}`" :style="{marginBottom: `${data.spacing.value}px`}">
                  <div class="icl-feature__detail">
                    <h2 class="icl-feature__title" ><InlineEditor v-model="item.title.value" /></h2>
                    <div class="icl-feature__content" ><InlineEditor v-model="item.content.value" /></div>
                  </div>
  ...
  static function render($id, $data, $style) {
    ...
    <div
      ...
      class="icl-section icl-section--feature-8 content-<?php echo $style->content_color->value; ?>">
      <?php
        $background_style  = "";
      ...
      <div class="<?php echo (!$style->fullwidth->value) ? 'container' : 'container-fluid'; ?>">
        ...
        <div class="content-spacer" style="padding: <?php echo implode(" ", $padding); ?>">
          ...
          <div class="columns is-vcentered is-variable is-8">
            <div class="column">
              <div class="feature-list">
                <?php foreach( $data->features_1->value as $item ): ?>
            ...
            <div class="column">
              ...
              <div class="feature-list">
                <?php foreach( $data->features_2->value as $item ): ?>
                  <div class="icl-feature icl-feature--style-8" style="margin-bottom:<?php echo $data->spacing->value; ?>px">
                    <div class="icl-feature__detail">
                      <h2 class="icl-feature__title"><?php echo $item->title->value;  ?></h2>
                      <div class="icl-feature__content">
...
$feature8 = new Feature8();
$arrayCode[] = $feature8->data();
$arrayTemplate[] = $feature8->editorTemplate();