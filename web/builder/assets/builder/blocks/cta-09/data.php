...
class CTA9 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'cta-09',
      "title"      => 'CTA 9',
      "screenshot" => 'cta-09/cta-09.jpg',
      "screenshot_size" => array( 600, 233 ),
      "template"   => '#cta-09',
      "category"   => 'call-to-action',
        "data" => array(
          ...
          "image" => array(
            "type" => "image",
            "label" => "Image",
            "value" => $this->base_url . 'builder/assets/builder/blocks-assets/imgs/photos/phone-mockup.png'
          ),
          "buttons" => array(
            "type" => "repeatable",
            "label" => "Image Button",
            "settings" => array(
              "image" => array(
                "type" => "image",
                "label" => "Button image",
                "value" => $this->base_url . 'assets/builder/blocks-assets/imgs/buttons/google.png'
              ),
              "url" => array(
                "type" => "text",
                "label" => "URL",
            ...
            "value" => array(
              array(
                "image" => array(
                  "type" => "image",
                  "label" => "Button image",
                  "value" => $this->base_url . 'assets/builder/blocks-assets/imgs/buttons/apple.png'
                ),
                "url" => array(
                  "type" => "text",
                  "label" => "URL",
  ...
  public function editorTemplate() {
    ...
    <div
      :id="`block-${id}`"
      class="icl-section icl-section--cta-9"
      ...
      <div :class="{'container': !style.fullwidth.value, 'container-fluid': style.fullwidth.value }">
        <div :class="`content-spacer`" :style="{'padding': `${style.padding.value.top}px ${style.padding.value.right}px ${style.padding.value.bottom}px ${style.padding.value.left}px`}">
          <div class="columns is-vcentered" :class="{'row-reverse': data.reverse.value == true }">
            <div :class="`column is-two-thirds column-content ${data.alignment.value}`">
              ...
              <div class="cta-buttons">
                <a :target="button.new_window.value ? '_blank' : ''" :href="button.url.value" v-for="button in data.buttons.value"><img :src="button.image.value"></a>
              </div>
            </div>
  ...
  static function render($id, $data, $style) {
    ...
    <div
      ...
      class="icl-section icl-section--cta-9 content-<?php echo $style->content_color->value; ?>">
      <?php
        $background_style  = "";
        ...
        <div class="content-spacer" style="padding: <?php echo implode(" ", $padding); ?>">
          <div class="columns is-vcentered <?php echo $data->reverse->value == true ? "row-reverse" : ""; ?>">
            <div class="column is-half column-content <?php echo $data->alignment->value; ?>">
              ...
              <div class="cta-buttons">
                <?php foreach( $data->buttons->value as  $item ): ?>
                  <a href="<?php echo $item->url->value; ?>" <?php echo $item->new_window->value ? 'target="_blank"': "" ?>>
                    <img src="<?php echo $item->image->value; ?>">
                  </a>
                <?php endforeach; ?>
              </div>
            </div>
            <div class="column column-image is-half">
...
$CTA9 = new CTA9();
$arrayCode[] = $CTA9->data();
$arrayTemplate[] = $CTA9->editorTemplate();