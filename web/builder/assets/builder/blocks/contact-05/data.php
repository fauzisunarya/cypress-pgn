...
class Contact5 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'contact-05',
      "title"      => 'Contact 5',
      "screenshot" => 'contact-05/contact-05.jpg',
          ...
          <div class="columns is-centered <?php echo $data->alignment->value ?>">
            <div class="column is-8">
              ...
              <div class="form-wrapper button-parent-style <?php echo $data->button_style->value; ?> <?php echo $data->button_corner->value; ?> submit-button-<?php echo $data->button_alignment->value;  ?>" style="--background:<?php echo $data->button_bg->value; ?>;--foreground:<?php echo $data->button_color->value; ?>">
                <?php 
                  $render->render_form_custom(isset($data->form) ? $data->form->value : "", array("show-label" => isset($data->form) ? $data->form->settings->label : true ) );
                ?>
              </div>
            </div>
          </div>
...
$contact5 = new Contact5();
$arrayCode[] = $contact5->data();
$arrayTemplate[] = $contact5->editorTemplate();