...
class Product5 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'product-05',
      "title"      => 'Product 5',
      "screenshot" => 'product-05/product-05.jpg',
      "screenshot_size" => array( 600, 256 ),
      "template"   => '#product-05',
      "category"   => 'product',
        "data" => array(
          "title_top" => array(
          ...
          "content" => array(
            "type"            => 'wyswyg',
            "label"           => 'Konten',
            "value"           => "<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minus error ullam quam, accusantium, eaque repellat rem. Blanditiis officiis, reprehenderit nesciunt!</p><ul><li>Menicure & Pedicure</li><li>All body Massage</li><li>Creambath</li><li>Waxing</li></ul>",
          ),
        ...
        <div :class="`content-spacer`" :style="{'padding': `${style.padding.value.top}px ${style.padding.value.right}px ${style.padding.value.bottom}px ${style.padding.value.left}px`}">
          <div class="columns is-vcentered" :class="{'row-reverse': data.reverse.value == true }">
            ...
            <div class="column is-6">
              <img v-if="data.image.value" :src="data.image.value" class="image-styled">
            </div>
          </div>
        </div>
      </div>
    ...
    <div
      ...
      <div class="content-spacer" style="padding: <?php echo implode(" ", $padding); ?>">
        <div class="columns is-vcentered <?php echo $data->reverse->value == true ? "row-reverse" : ""; ?>">
          ...
          <div class="column is-1"></div>
          <div class="column is-6" data-aos="fade-up" data-aos-delay="300">
...
$arrayCode[] = $product5->data();
$arrayTemplate[] = $product5->editorTemplate();