...
class Team5 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'team-05',
      "title"      => 'Team 5',
      "screenshot" => 'team-05/team-05.jpg',
  ...
  public function editorTemplate() {
    ...
    <div
      :id="`block-${id}`"
      class="icl-section icl-section--team-5"
      ...
      <div :class="{'container': !style.fullwidth.value, 'container-fluid': style.fullwidth.value }">
        <div :class="`content-spacer`" :style="{'padding': `${style.padding.value.top}px ${style.padding.value.right}px ${style.padding.value.bottom}px ${style.padding.value.left}px`}">
          ...
          <Sortable class="icl-team-grid justify-content-center" v-model="data.teams.value">
            <SortableItem class="slide icl-team icl-team--style-5" v-for="(item, index) in data.teams.value" :key="`item-${index}`" :list="data.teams.value" :index="index">
  ...
  static function render($id, $data, $style) {
    ...
    <div
      ...
      class="icl-section icl-section--team-5 content-<?php echo $style->content_color->value; ?>">
      <?php
        $background_style  = "";
      ...
      <div class="content-spacer" style="padding: <?php echo implode(" ", $padding); ?>">
        ...
        <div class="icl-team-grid justify-content-center">
          <?php foreach( $data->teams->value as $item ): ?>
            <div class="slide icl-team icl-team--style-5">
              <div class="icl-team__card">
...
$team5 = new Team5();
$arrayCode[] = $team5->data();
$arrayTemplate[] = $team5->editorTemplate();