...
class Team6 {
  ...
  public function data() {
    ...
    return array(
      "blockID"    => 'team-06',
      "title"      => 'Team 6',
      "screenshot" => 'team-06/team-06.jpg',
      "screenshot_size" => array( 946, 507 ),
      "template"   => '#team-06',
      "category"   => 'team',
        "data" => array(
          "title" => array(
            ...
            "value"  => array(
              array(
                ...
                "title" => array(
                  ...
                  "label" => "Title Penulis",
                  "horizontal" => true,
                  "value" => "Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus, fuga!"
                ),
                // social media icons
                "social" => array(
                  "type" => "repeatable",
  ...
  public function editorTemplate() {
    ...
    <div
      :id="`block-${id}`"
      class="icl-section icl-section--team-6"
      ...
      <div :class="{'container': !style.fullwidth.value, 'container-fluid': style.fullwidth.value }">
        <div :class="`content-spacer`" :style="{'padding': `${style.padding.value.top}px ${style.padding.value.right}px ${style.padding.value.bottom}px ${style.padding.value.left}px`}">
          ...
          <Sortable class="icl-team-grid justify-content-center" v-model="data.teams.value">
            <SortableItem class="slide icl-team icl-team--style-6" v-for="(item, index) in data.teams.value" :key="`item-${index}`" :list="data.teams.value" :index="index">
              <div class="icl-team__card">
                <!-- photo -->
                <img class="icl-team__avatar" :src="item.avatar.value">

                <!-- name -->
                <h3 class="icl-team__name" style="margin-top: 10px;"><InlineEditor v-model="item.name.value"/></h3>

                <!-- description -->
                <p class="icl-team__title"><InlineEditor v-model="item.title.value"/></p>

                <!-- multi sosmed button -->
                <div class="navbar-social-icons is-pulled-left" style="margin-top: -10px; width: 100%;">
  ...
  static function render($id, $data, $style) {
    ...
    <div
      ...
      class="icl-section icl-section--team-6 content-<?php echo $style->content_color->value; ?>">
      <?php
        $background_style  = "";
      ...
      <div class="content-spacer" style="padding: <?php echo implode(" ", $padding); ?>">
        ...
        <div class="icl-team-grid justify-content-center">
          <?php foreach( $data->teams->value as $item ): ?>
            <div class="slide icl-team icl-team--style-6">
              <div class="icl-team__card">
                ...
                <!-- name -->
                <h3 class="icl-team__name" style="margin-top: 10px;"><?php echo $item->name->value;  ?></h3>
                
                <!-- description -->
                <p class="icl-team__title"><?php echo $item->title->value;  ?></p>
...
$team6 = new Team6();
$arrayCode[] = $team6->data();
$arrayTemplate[] = $team6->editorTemplate();